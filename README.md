...
- [SubTrackr](https://github.com/bscott/subtrackr) - A self-hosted subscription tracker to help you manage recurring payments and stay on top of your expenses. `MIT` `Go/Docker`
